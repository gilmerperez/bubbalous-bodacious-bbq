          ...
          <div className={styles.bottomContainer}>
            ...
            <section className={styles.siteNavigation} aria-labelledby="pages-heading">
              ...
              <nav className={styles.navItems} aria-label="Main site navigation">
                ...
                <Link href="/menu" aria-label="View our menu">
                  Menu
                </Link>
                <Link href="/party-packs" aria-label="Browse party packs">
                  Party Packs
                </Link>
                <Link href="/order-online" aria-label="Order online">
                  Order Online
                </Link>
              </nav>
            </section>
            ...
            <section className={styles.socialLinks} aria-labelledby="connect-heading">
              ...
              <nav className={styles.navItems} aria-label="Social media links">
                ...
                <a
                  ...
                  href="https://www.google.com/search?sca_esv=0683e8ae5cdf4a07&rlz=1C1RXQR_enUS1087US1087&si=AMgyJEuzsz2NflaaWzrzdpjxXXRaJ2hfdMsbe_mSWso6src8s34WnzVthE3GbcLciAEjUQUYUqE_SrVCus3YtmY4GEJIahcP2Vl5otO8QtxszA113kkHURCO9gJvLjZe4SmqwVbZ057Dx--UABgG2IawYo454kpkVw%3D%3D&q=Bubbalou%27s+Bodacious+Bar-B-Que+Reviews&sa=X&ved=2ahUKEwiT-LCsnaCQAxXbRjABHTnPCbQQ0bkNegQIORAE&biw=1745&bih=828&dpr=1.1"
                >
                  Google Page
                </a>
              </nav>
            ...
            <section className={styles.legalPages} aria-labelledby="legal-heading">
              ...
              <nav className={styles.navItems} aria-label="Legal pages">
                ...
                <Link href="/privacy-policy" aria-label="Read our privacy policy">
                  Privacy Policy
                </Link>
                <Link href="/terms-of-service" aria-label="Read our terms of service">
                  Terms of Service
                </Link>
              </nav>
            </section>
            ...
            <section className={styles.contactInfo} aria-labelledby="contact-heading">
              ...
              <nav className={styles.navItems} aria-label="Contact information">
                ...
                <a
                  ...
                  href="https://www.google.com/maps/place/5818+Conroy+Rd,+Orlando,+FL+32835/@28.4932644,-81.4634049,868m/data=!3m2!1e3!4b1!4m6!3m5!1s0x88e77ecdf6ef68b5:0x7db71923947402f4!8m2!3d28.4932644!4d-81.4608246!16s%2Fg%2F11bw3yh66m?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D"
                >
